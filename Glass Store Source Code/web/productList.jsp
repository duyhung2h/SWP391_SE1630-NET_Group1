            ...
            <div class="card bg-light mb-3">
                ...
                <ul class="list-group category_block">
                        ...
                        <li class="list-group-item text-white ">
                            <a href="productList?CategoryID=1"><i class="fas fa-laptop" aria-hidden="true"></i> Kính Cận</a>
                        </li>
                    
                        <li class="list-group-item text-white active">
                            <a href="productList?CategoryID=2"><i class="fas fa-desktop" aria-hidden="true"></i> Kính Râm Thời Trang</a>
                        </li>
                    
                        <li class="list-group-item text-white ">
                            <a href="productList?CategoryID=3"><i class="far fa-folder-open" aria-hidden="true"></i> Kính Áp Tròng</a>
                        </li>
                    
                        <li class="list-group-item text-white ">
                            <a href="productList?CategoryID=4"><i class="far fa-keyboard" aria-hidden="true"></i> Kính Lão-Viễn</a>
                        </li>
                    
                        <li class="list-group-item text-white ">
                            <a href="productList?CategoryID=5"><i class="fas fa-mobile-alt" aria-hidden="true"></i> Gọng Kính</a>
                        </li>
                    
                        <li class="list-group-item text-white ">
                            <a href="productList?CategoryID=6"><i class="fas fa-tablet-alt" aria-hidden="true"></i> Mắt Kính</a>
                        </li>
                    
                        <li class="list-group-item text-white ">
                            <a href="productList?CategoryID=7"><i class="fas fa-headphones" aria-hidden="true"></i> Kính Bơi</a>
                        </li>
